...
namespace Application.Helpers
{
  ...
  {
    private List<App> ReadAllInstalledApps()
    {
      ...
      return (from app in (IKnownFolder) appsFolder select new App {Name = app.Name, AppUserModelId = app.ParsingName, Icon = BitmapToByteArray(app.Thumbnail.Bitmap)}).ToList();
    ...
    private static byte[] BitmapToByteArray(Image bitmap)
    {
